          ...
          <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              <?php if(in_array('pages.list', $actions)) :?>
                <li><a href="<?php echo Uri::create('/sidor/'); ?>"><?php echo __('Sidor'); ?></a></li>
              <?php endif; ?>
              <?php if(in_array('spex.list', $actions)) :?>
                <li><a href="<?php echo Uri::create('/spex/'); ?>"><?php echo __('Spex'); ?></a></li>
              <?php endif; ?>        
              <?php if(in_array('users.list', $actions)) :?>
                <li><a href="<?php echo Uri::create('/anvandare/'); ?>"><?php echo __('Användare'); ?></a></li>
              <?php endif; ?>        
              <?php if(in_array('memberships.list', $actions)) :?>
                <li><a href="<?php echo Uri::create('/medlemskap/'); ?>"><?php echo __('Medlemskap'); ?></a></li>
              <?php endif; ?>        
              <?php if(in_array('roles.list', $actions)) :?>
                <li><a href="<?php echo Uri::create('/roller/'); ?>"><?php echo __('Roller'); ?></a></li>
              <?php endif; ?>        
              ...
              <?php if(in_array('news.list', $actions)) :?>
                <li><a href="<?php echo Uri::create('/nyheter/'); ?>"><?php echo __('Nyheter'); ?></a></li>
              <?php endif; ?>        
              <?php if(in_array('actions.list', $actions)) :?>
                <li><a href="<?php echo Uri::create('/atgarder/'); ?>"><?php echo __('Åtgärder'); ?></a></li>
              <?php endif; ?>        
              <?php if(in_array('tickets.list', $actions)) :?>
                <li><a href="<?php echo Uri::create('/biljetter/'); ?>"><?php echo __('Biljetter'); ?></a></li>
              <?php endif; ?>        
              <?php if(in_array('contacts.list', $actions)) :?>
                <li><a href="<?php echo Uri::create('/kontakter/'); ?>"><?php echo __('Kontakter'); ?></a></li>
              <?php endif; ?>        
              <?php if(in_array('images.list', $actions)) :?>
                <li><a href="<?php echo Uri::create('/biljetter/'); ?>"><?php echo __('Bilder'); ?></a></li>
              <?php endif; ?>        
